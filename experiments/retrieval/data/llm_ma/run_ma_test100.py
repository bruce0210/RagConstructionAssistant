...
def main() -> None:
    ...
    out_agents = f"test100/outputs/{run_tag}.agents.jsonl"
    out_final  = f"test100/outputs/{run_tag}.final.jsonl"
    out_adj    = f"test100/outputs/{run_tag}.adjudication.jsonl"
    out_err    = f"test100/outputs/{run_tag}.errors.jsonl"
    log_path   = f"test100/logs/{run_tag}.log"

    os.makedirs("test100/outputs", exist_ok=True)
    os.makedirs("test100/logs", exist_ok=True)

...
def main():
    ...
    ap.add_argument("--queries", default="data/test_queries.jsonl")
    ap.add_argument("--labels", default="data/test_labels.json")
    ...
    out_details = os.path.join(args.out_dir, "test_colbert_details.jsonl")
    out_group = os.path.join(args.out_dir, "test_colbert_group_metrics.json")
